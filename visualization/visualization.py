...
if __name__ == '__main__':
    ...
    parser.add_argument('--object_code', type=str, default='100015')
    parser.add_argument('--num', type=int, default=0)
    parser.add_argument('--no_st', type=bool, default=True)
    parser.add_argument('--test', type=bool, default=False)
    parser.add_argument('--result_path', type=str, default='/media/george/Projects/Research/2026-CVPR-BiDexHand/affordance-bidex/third_party/DexGraspNet2/experiments/bimanual_full_kp')
    ...
    object_model = ObjectModel(
        data_root_path='/media/george/Projects/Research/2026-CVPR-BiDexHand/affordance-bidex/data/sapien_data/preprocessed_meshes',
        batch_size_each=1,
        num_samples=2000, 
        device=device,
        size='large'
